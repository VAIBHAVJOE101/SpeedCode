...
function CodeChefQuestionCard({id, questionTitle, questionDifficulty, questionLink, done}) {
    return (
        <Card m="20px 0px 0px 0px" minw="1100px" h="90px" p="20px" bg="rgba(109, 181, 181, 0.33)" display="flex" alignItems="center" justify="space-between">
                ...
                <Typography m="10px 0px 0px 20px"  fs="15px" color="white" ff={font.encode} fw={600}>question Difficulty : {questionDifficulty}</Typography>
                </div>
...
export default CodeChefQuestionCard;
